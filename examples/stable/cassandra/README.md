...
* Kanister controller version 0.35.0 installed in your cluster, let's say in namespace `<kanister-operator-namespace>`
...
$ helm install --namespace "<app-namespace>" "cassandra" incubator/cassandra --set image.repo=kanisterio/cassandra --set image.tag=0.35.0 --set config.cluster_size=2
```
