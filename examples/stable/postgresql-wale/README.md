...
- Kanister controller version 0.51.3 installed in your cluster
...
$ helm install --name kanister --namespace kasten-io kanister/kanister-operator --set image.tag=0.51.3
```
