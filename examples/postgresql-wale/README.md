...
- Kanister controller version 0.117.0 installed in your cluster
...
$ helm install my-release bitnami/postgresql  \
	...
	--set postgresqlExtendedConf.archiveCommand="'envdir /bitnamilegacy/postgresql/data/env wal-e wal-push %p'" \
...
$ helm install kanister --namespace kanister --create-namespace kanister/kanister-operator --set image.tag=0.117.0
```
