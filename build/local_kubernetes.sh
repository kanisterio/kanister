...
export KUBE_VERSION=${KUBE_VERSION:-"v1.35.8"}
...
export SNAPSHOTTER_VERSION="v8.6.0"
export HOSTPATH_DRIVER_VERSION="v1.18.0"
...
# using `helm/kind-action` instead in our github actions source file
