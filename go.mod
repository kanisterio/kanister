...
require (
	...
	k8s.io/api v0.26.14
	k8s.io/apiextensions-apiserver v0.26.14
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/storage/azblob v1.2.1 // indirect; indirect;
...
require github.com/kanisterio/safecli v0.0.4
