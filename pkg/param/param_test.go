...
func (s *ParamsSuite) testNewTemplateParams(ctx context.Context, c *check.C, dynCli dynamic.Interface, object crv1alpha1.ObjectReference) {
	...
	osCli := osfake.NewSimpleClientset() // TODO(K10-38337): switch to NewClientset once the applyconfig OpenAPI schema is generated for kanister CRDs

	crCli := crfake.NewSimpleClientset() // TODO(K10-38337): switch to NewClientset once the applyconfig OpenAPI schema is generated for kanister CRDs
