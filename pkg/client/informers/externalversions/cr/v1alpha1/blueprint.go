	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrV1alpha1().Blueprints(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrV1alpha1().Blueprints(namespace).Watch(options)
			},
		},
		&cr_v1alpha1.Blueprint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *blueprintInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cr_v1alpha1.Blueprint{}, f.defaultInformer)
}
