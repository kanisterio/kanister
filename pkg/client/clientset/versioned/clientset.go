...
// Package versioned provides a clientset for interacting with the Kanister API groups.
// This package is generated by client-gen and should not be edited manually.
package versioned
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.crV1alpha1, err = crv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
