...
type blueprints struct {
	*gentype.ClientWithListAndApply[*v1alpha1.Blueprint, *v1alpha1.BlueprintList, *crv1alpha1.BlueprintApplyConfiguration]
}

// newBlueprints returns a Blueprints
func newBlueprints(c *CrV1alpha1Client, namespace string) *blueprints {
	return &blueprints{
		gentype.NewClientWithListAndApply[*v1alpha1.Blueprint, *v1alpha1.BlueprintList, *crv1alpha1.BlueprintApplyConfiguration](
			"blueprints",
			c.RESTClient(),
