...
type RepositoryServerLister interface {
	...
	List(selector labels.Selector) (ret []*crv1alpha1.RepositoryServer, err error)
...
type repositoryServerLister struct {
	listers.ResourceIndexer[*crv1alpha1.RepositoryServer]
}
...
func NewRepositoryServerLister(indexer cache.Indexer) RepositoryServerLister {
	return &repositoryServerLister{listers.New[*crv1alpha1.RepositoryServer](indexer, crv1alpha1.Resource("repositoryserver"))}
}

// RepositoryServers returns an object that can list and get RepositoryServers.
func (s *repositoryServerLister) RepositoryServers(namespace string) RepositoryServerNamespaceLister {
	return repositoryServerNamespaceLister{listers.NewNamespaced[*crv1alpha1.RepositoryServer](s.ResourceIndexer, namespace)}
}
...
type RepositoryServerNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*crv1alpha1.RepositoryServer, error)
