...
type ActionSetLister interface {
	...
	List(selector labels.Selector) (ret []*crv1alpha1.ActionSet, err error)
...
type actionSetLister struct {
	listers.ResourceIndexer[*crv1alpha1.ActionSet]
}

// NewActionSetLister returns a new ActionSetLister.
func NewActionSetLister(indexer cache.Indexer) ActionSetLister {
	return &actionSetLister{listers.New[*crv1alpha1.ActionSet](indexer, crv1alpha1.Resource("actionset"))}
}

// ActionSets returns an object that can list and get ActionSets.
func (s *actionSetLister) ActionSets(namespace string) ActionSetNamespaceLister {
	return actionSetNamespaceLister{listers.NewNamespaced[*crv1alpha1.ActionSet](s.ResourceIndexer, namespace)}
}
...
type ActionSetNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*crv1alpha1.ActionSet, error)
