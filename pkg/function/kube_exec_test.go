...
func (s *KubeExecTest) TestParseLogAndCreateOutput(c *C) {
	for _, tc := range []struct {
		...
		{"###Phase-output###: {\"key\":\"version\",\"value\":\"0.38.0\"}", map[string]interface{}{"version": "0.38.0"}, IsNil, NotNil},
		{"###Phase-output###: {\"key\":\"version\",\"value\":\"0.38.0\"}\n###Phase-output###: {\"key\":\"path\",\"value\":\"/backup/path\"}",
			map[string]interface{}{"version": "0.38.0", "path": "/backup/path"}, IsNil, NotNil},
		{"Random message ###Phase-output###: {\"key\":\"version\",\"value\":\"0.38.0\"}", map[string]interface{}{"version": "0.38.0"}, IsNil, NotNil},
