...
func (s *KubeExecTest) TestKubeExec(c *C) {
	...
	for _, p := range phases {
		_, err = p.Exec(context.Background(), nil, nil, *bp, action, *tp)
		c.Assert(err, IsNil)
	}
}
...
func (s *KubeExecTest) TestParseLogAndCreateOutput(c *C) {
	for _, tc := range []struct {
		...
		{"###Phase-output###: {\"key\":\"version\",\"value\":\"0.85.0\"}", map[string]interface{}{"version": "0.85.0"}, IsNil, NotNil},
		{"###Phase-output###: {\"key\":\"version\",\"value\":\"0.85.0\"}\n###Phase-output###: {\"key\":\"path\",\"value\":\"/backup/path\"}",
			map[string]interface{}{"version": "0.85.0", "path": "/backup/path"}, IsNil, NotNil},
		{"Random message ###Phase-output###: {\"key\":\"version\",\"value\":\"0.85.0\"}", map[string]interface{}{"version": "0.85.0"}, IsNil, NotNil},
