...
const (
	...
	defaultPostgresToolsImage = "ghcr.io/kanisterio/postgres-kanister-tools:0.118.0"
)
...
func execDumpCommand(
	...
	return kubeTask(ctx, cli, namespace, postgresToolsImage, command, nil, injectPostgresSecrets(secretName), annotations, labels, nil)
}
