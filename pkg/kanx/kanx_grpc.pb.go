...
const (
	ProcessService_CreateProcesses_FullMethodName = "/kanx.ProcessService/CreateProcesses"
...
type ProcessServiceClient interface {
	...
	Stdout(ctx context.Context, in *ProcessOutputRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Output], error)
	Stderr(ctx context.Context, in *ProcessOutputRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Output], error)
}
...
func (c *processServiceClient) CreateProcesses(ctx context.Context, in *CreateProcessRequest, opts ...grpc.CallOption) (*Process, error) {
	...
	out := new(Process)
	err := c.cc.Invoke(ctx, ProcessService_CreateProcesses_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *processServiceClient) Stdout(ctx context.Context, in *ProcessOutputRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Output], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ProcessService_ServiceDesc.Streams[1], ProcessService_Stdout_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ProcessOutputRequest, Output]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *processServiceClient) Stderr(ctx context.Context, in *ProcessOutputRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Output], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProcessServiceServer interface {
	...
	Stdout(*ProcessOutputRequest, grpc.ServerStreamingServer[Output]) error
	Stderr(*ProcessOutputRequest, grpc.ServerStreamingServer[Output]) error
...
func (UnimplementedProcessServiceServer) Stdout(*ProcessOutputRequest, grpc.ServerStreamingServer[Output]) error {
	return status.Errorf(codes.Unimplemented, "method Stdout not implemented")
}
func (UnimplementedProcessServiceServer) Stderr(*ProcessOutputRequest, grpc.ServerStreamingServer[Output]) error {
...
func _ProcessService_CreateProcesses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProcessService_CreateProcesses_FullMethodName,
	}
...
func _ProcessService_Stdout_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ProcessServiceServer).Stdout(m, &grpc.GenericServerStream[ProcessOutputRequest, Output]{ServerStream: stream})
}
...
func _ProcessService_Stderr_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ProcessServiceServer).Stderr(m, &grpc.GenericServerStream[ProcessOutputRequest, Output]{ServerStream: stream})
}
