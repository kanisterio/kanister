...
func (s *AnnotationsSuite) TestAnnotationsFromEnvVarCoreV1PodInvalidJSON(c *check.C) {
...
func (s *AnnotationsSuite) TestAnnotationsFromEnvVarCoreV1PodInvalidAnnotations(c *check.C) {
	invalidAnnotations := `{"/key": "value"}`
