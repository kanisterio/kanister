...
func (s *IntegrationSuite) SetUpSuite(c *check.C) {
	...
	log.Info().Print("starting integration test suite", field.M{"image_tag": app.DefaultImageTag})
...
func (s *IntegrationSuite) TestRun(c *check.C) {
	...
	profileName := s.createProfile(ctx, c)
...
func (s *IntegrationSuite) createProfile(ctx context.Context, c *check.C) string {
