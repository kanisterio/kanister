...
var _ = check.Suite(&PITRPostgreSQL{
	IntegrationSuite{
		...
		bp:        app.NewPITRBlueprint("pitr-postgres", "postgresql-wale", app.DefaultImageTag),
...
var _ = check.Suite(&PostgreSQL{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("postgres", "", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&MySQL{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("mysql", "", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&CockroachDB{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("cockroachdb", "", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&TimeLogCSI{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("csi-snapshot", "", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&Maria{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("maria", "", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&Elasticsearch{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("elasticsearch", "", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&MongoDB{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("mongo", "mongodb", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&Cassandra{IntegrationSuite{
	...
	bp:        app.NewBlueprint("cassandra", "", "", app.DefaultImageTag),
	profile:   newSecretProfile(),
},
})
...
var _ = check.Suite(&Couchbase{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("couchbase", "", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&RDSPostgreSQL{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("rds-postgres", "aws-rds-postgres", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&FoundationDB{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("foundationdb", "", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&RDSAuroraMySQL{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("rds-aurora-snap", "aws-rds-aurora-snap", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&RDSPostgreSQLDump{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("rds-postgres-dump", "aws-rds-postgres-dump", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&RDSPostgreSQLSnap{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("rds-postgres-snap", "aws-rds-postgres-snap", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&MSSQL{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("mssql", "", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&MysqlDBDepConfig{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("mysql-dep-config", "", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&MongoDBDepConfig{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("mongo-dep-config", "mongodb-dep-config", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&Kafka{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("kafka", "", "", app.DefaultImageTag),
		profile:   newSecretProfile(),
	},
})
