...
var _ = check.Suite(&MongoDB{
	IntegrationSuite{
		...
		app:       app.NewMongoDB("mongodb"),
		bp:        app.NewBlueprint("mongodb", true),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&RDSPostgreSQL{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("aws-rds-postgres", true),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&RDSPostgreSQLDump{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("aws-rds-postgres-pgdump", true),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&RDSPostgreSQLSnap{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("aws-rds-postgres-snap", true),
		profile:   newSecretProfile(),
	},
})
...
var _ = check.Suite(&MongoDBDepConfig{
	IntegrationSuite{
		...
		bp:        app.NewBlueprint("mongodb-dep-config", true),
		profile:   newSecretProfile(),
	},
})
