...
func (m *MockSnapshotter) Clone(ctx context.Context, name, namespace string, waitForReady bool, snapshotMeta, contentMeta snapshot.SnapshotMeta) error {
	m.ctrl.T.Helper()
...
func (m *MockSnapshotter) Create(ctx context.Context, pvcName string, snapshotClass *string, waitForReady bool, snapshotMeta snapshot.SnapshotMeta) error {
	m.ctrl.T.Helper()
...
func (m *MockSnapshotter) CreateContentFromSource(ctx context.Context, source *snapshot.Source, deletionPolicy string, snapshotMeta, contentMeta snapshot.SnapshotMeta) error {
	m.ctrl.T.Helper()
...
func (m *MockSnapshotter) CreateFromSource(ctx context.Context, source *snapshot.Source, waitForReady bool, snapshotMeta, contentMeta snapshot.SnapshotMeta) error {
	m.ctrl.T.Helper()
