...
func newRepositoryServerCommand() *cobra.Command {
	...
	cmd.PersistentFlags().StringP(repoServerUserAccessSecretFlag, "p", "", "name of the secret having user access password and host")
	...
	cmd.PersistentFlags().StringP(repoServerAdminUserFlag, "p", "", "prefix to be set in kopia repository")
