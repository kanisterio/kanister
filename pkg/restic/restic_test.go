...
func (s *ResticDataSuite) TestGetSnapshotIDFromTag(c *check.C) {
	for _, tc := range []struct {
		...
		{
			log: `[{"time":"2019-03-28T17:35:15.146526-07:00","hostname":"MacBook-Pro.local","username":"abc",` +
				`"uid":501,"gid":20,"tags":["backup123"],"id":"7c0bfeb93dd5b390a6eaf8a386ec8cb86e4631f2d96400407b529b53d979536a",` +
				`"short_id":"7c0bfeb9"}]`,
			expected: "7c0bfeb9",
			checker:  check.IsNil,
		},
		{
			log: `[{"time":"2019-03-28T17:35:15.146526-07:00","hostname":"MacBook-Pro.local","username":"abc",` +
				`"uid":501,"gid":20,"tags":["backup123"],"id":"7c0bfeb93dd5b390a6eaf8a386ec8cb86e4631f2d96400407b529b53d979536a",` +
				`"short_id":"7c0bfeb9"},{"time":"2019-03-28T17:35:15.146526-07:00","hostname":"MacBook-Pro.local",` +
				`"username":"abc","uid":501,"gid":20,"tags":["backup123"],` +
				`"id":"7c0bfeb93dd5b390a6eaf8a386ec8cb86e4631f2d96400407b529b53d979536a","short_id":"7c0bfeb9"}]`,
			expected: "7c0bfeb9",
			checker:  check.IsNil,
		},
...
func (s *ResticDataSuite) TestBackupCommandByTagWithCD(c *check.C) {
	for _, tc := range []struct {
	...
	}{
		{
			...
			expected: []string{
				...
				"export AWS_ACCESS_KEY_ID=id\n export AWS_SECRET_ACCESS_KEY=secret\n " +
					...
					"cd /mnt/vol_data/test-pvc restic backup --tag my-tag .",
			},
		},
		{
			profile: &param.Profile{
			...
			expected: []string{
				...
				"export AWS_ACCESS_KEY_ID=id\n export AWS_SECRET_ACCESS_KEY=secret\n " +
					"export RESTIC_REPOSITORY=s3:endpoint/repo\n export RESTIC_PASSWORD=my-secret\n " +
					"cd /mnt/data restic backup --tag backup-tag . --insecure-tls",
			},
		},
	} {
		cmd, err := BackupCommandByTagWithCD(tc.profile, tc.repo, tc.tag, tc.mountPoint, tc.password, tc.insecureTLS)
		c.Assert(err, check.IsNil)
		c.Assert(cmd, check.DeepEquals, tc.expected)
	}
}
