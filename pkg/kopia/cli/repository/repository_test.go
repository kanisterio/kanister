...
var _ = check.Suite(test.NewCommandSuite([]test.CommandTest{
	...
	{
		Name: "RepositoryCreate with azure location",
		CLI: func() (safecli.CommandBuilder, error) {
			args := CreateArgs{
				CommonArgs:      test.CommonArgs,
				CacheArgs:       cacheArgs,
	...
	{
		Name: "RepositoryCreate with gcs location",
		CLI: func() (safecli.CommandBuilder, error) {
			args := CreateArgs{
				CommonArgs:      test.CommonArgs,
				CacheArgs:       cacheArgs,
	...
	{
		Name: "RepositoryCreate with s3 location",
		CLI: func() (safecli.CommandBuilder, error) {
			args := CreateArgs{
				CommonArgs:      test.CommonArgs,
				CacheArgs:       cacheArgs,
	...
	{
		Name: "RepositoryCreate with s3 compliant location",
		CLI: func() (safecli.CommandBuilder, error) {
			args := CreateArgs{
				CommonArgs:      test.CommonArgs,
				CacheArgs:       cacheArgs,
