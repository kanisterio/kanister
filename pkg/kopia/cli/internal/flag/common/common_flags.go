...
var (
	All           = flag.SwitchFlag("--all")
	Delta         = flag.SwitchFlag("--delta")
	ShowIdentical = flag.SwitchFlag("--show-identical")
	NoGRPC        = flag.SwitchFlag("--no-grpc")
)
