...
// Package repository provides functionality to interact with Kopia repositories,
// including connecting to the Kopia API server, opening repositories, and managing
