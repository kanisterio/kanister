...
import (
	...
	crkanisteriov1alpha1 "github.com/kanisterio/kanister/pkg/kopia/repositoryserver/pkg/apis/cr.kanister.io/v1alpha1"
	versioned "github.com/kanisterio/kanister/pkg/kopia/repositoryserver/pkg/client/clientset/versioned"
	internalinterfaces "github.com/kanisterio/kanister/pkg/kopia/repositoryserver/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kanisterio/kanister/pkg/kopia/repositoryserver/pkg/client/listers/cr.kanister.io/v1alpha1"
...
func NewFilteredRepositoryServerInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&crkanisteriov1alpha1.RepositoryServer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *repositoryServerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crkanisteriov1alpha1.RepositoryServer{}, f.defaultInformer)
}
